...
convertForm.addEventListener("submit", (e) => {
	...
	setTimeout(() => {
		...
		if (degreeType.value === "celsius" && convertType.value === "fahrenheit") {
			...
			degreeType.value === "celsius" && convertType.value === "kelvin"
		) {
			celciusTokelvin(num);
		} else if (
			degreeType.value === "fahrenheit" && convertType.value === "celsius"
		) {
			FahrenheitToCelcius(num);
		} else if (
			degreeType.value === "fahrenheit" && convertType.value === "kelvin"
		) {
			FahrenheitToKelvin(num);
		} else if (
			degreeType.value === "kelvin" && convertType.value === "celsius"
		) {
			kelvinToCelcius(num);
		} else if (
			degreeType.value === "kelvin" && convertType.value === "fahrenheit"
		) {
